# adf-widget-nanomine-d3

nanomine-d3 widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-nanomine-d3
...
```html
<script type="text/javascript" src="path/to/nanomine-d3.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.nanomine-d3']);
```
